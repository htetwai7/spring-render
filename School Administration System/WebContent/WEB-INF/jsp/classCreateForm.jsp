...
<body class="body-container container">
	...
	<form:form method="post" action="saveClas">
		<nav class="navbar">
			<ul>
				<h5 class="header">Register New Class</h5>
			...
			<div class="table col-sm-3 ">
				<table class="table">
					<tr>
						...
						<td><input type="text" class="data" name="code" /></td>
					</tr>
				</table>
			</div>
			<div class="table col-sm-3 ">
				<table class="table">
					<tr>
						...
						<td><input type="text" class="data" name="description" /></td>
					</tr>
				</table>
			</div>
		</div>
